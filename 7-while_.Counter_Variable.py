...
while p >= q:
    p = p - q      #1  p -= q
    contador += 1    #2  VARIAVEL CONTADORA  
...
#1  p -= q
#2 +1 pois consegui fazer +1 subtacao e por ser a ultima instruç do while qdo é
#executada o fluxo da execução retorna p/ expessao do while(cond while) e segue,
# executando ate dar False - VARIAVEL CONTADORA
'''
