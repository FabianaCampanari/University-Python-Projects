...
divisor = 2
while divisor < n:    # equivale dizer divisor  <= n-1
     print(f'{n} % {divisor} = {n % divisor}')
     #instrucao testa(mostra cada rodada do laço
     if  n % divisor == 0:                                       
        break
     divisor += 1       #incrementado de 1 em 1
...
#valor de n,entao:
#Posse perguntar se o divisor é igual a n--if divisor ==n:
